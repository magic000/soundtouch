...
DIST_COMMON = $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/soundtouch.pc.in \
...
STRIP = strip
VERSION = 1.8.0
abs_builddir = /Users/mj/golang/src/code.inke.cn/wangmj/soundtouch
abs_srcdir = /Users/mj/golang/src/code.inke.cn/wangmj/soundtouch
...
installdirs-am:
	for dir in "$(DESTDIR)$(m4datadir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(pkgdocdir)"; do \
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-pkgconfigDATA install-pkgdocDATA install-ps \
